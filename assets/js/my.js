...
window.onload = async function (){
   ...
   var abi = [
    ...
    let contractOne = new ethers.Contract("0xf43fB53D4055AD4e36ee2a20A8A941dc10F3784A", abi, web3Provider);
   ...
   async function idoUserNft(){
    ...
    var abi = [
        ...
        let contractOne = new ethers.Contract("0xf43fB53D4055AD4e36ee2a20A8A941dc10F3784A", abi, walletWithProvider);
...
async function approve(){
    ...
    try {
        var approve = await contract.approve("0xf43fB53D4055AD4e36ee2a20A8A941dc10F3784A","100000000000000000000000000");
        await approve.wait(); 
    } catch (error) {
        loadingStop();
   ...
   if(!bools12){
    ...
    let Ucontract = new ethers.Contract("0x3d3981b1c3dae91bCF31F4620f48B7c226B11126", abi1, walletWithProvider);
     ...
     if(str == "#buyinput1"){
        price = priceList[0];
        rarity = 1;
     }else if(str == "#buyinput2"){
        price = priceList[1];
        rarity = 2;
     }else if(str == "#buyinput3"){
        price = priceList[2];
        rarity = 3;
     }else if(str == "#buyinput4"){
        price = priceList[3];
        rarity = 4;
     }else if(str == "#buyinput5"){
        price = priceList[4];
        rarity = 5;
     }else if(str == "#buyinput6"){
        price = priceList[5];
        rarity = 6;
    ...
    let contract = new ethers.Contract("0xf43fB53D4055AD4e36ee2a20A8A941dc10F3784A", abi, walletWithProvider);
    try {
